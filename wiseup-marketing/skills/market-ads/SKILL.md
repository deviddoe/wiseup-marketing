---
name: market-ads
description: Generate complete ad campaigns: platform-by-platform structures, copy variations, audience targeting and budget recommendations. Use when drafting paid creative and campaign structure.
---
...
_Bundled with Wiseup Marketing. Original: the `market-ads` skill of the AI Marketing Suite - https://github.com/zubair-trabzada/ai-marketing-claude - MIT licence, Copyright (c) 2026 Zubair Trabzada; licence text at `licences/zubair-trabzada-ai-marketing-claude-LICENSE`. Modifications: YAML frontmatter and the Wiseup Marketing integration note above were added. The body of the skill is unchanged._
